...
const WeatherApp = () => {
  let api_key = "4d00fb2adf8ee3ee9725cee0f0a274f0";
  ...
  const search = async () => {
    ...
    if (data && data.main) {
      ...
      if (humidity[0]) humidity[0].innerHTML = data.main.humidity + " %";
      if (wind[0]) wind[0].innerHTML = Math.floor(data.wind.speed) + " km/h";
      if (temperature[0])
        temperature[0].innerHTML = Math.floor(data.main.temp) + " °C";
      if (location[0]) location[0].innerHTML = data.name;
